...
public class ActivationFrame extends JFrame {
	...
	String orderTFvalue = "ARYORD";
	String infofilename =  All_Data.messageboxtitle.replace(" ", "")+"Win.aryinfo";

	String productversion = All_Data.messageboxtitle+"-V"+All_Data.version;
	...
	public ActivationFrame() {
		...
		setTitle(messageboxtitle + " "+All_Data.version);
